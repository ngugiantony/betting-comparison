            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-12" style="background: rgb(212, 116, 6);border-radius:15px;padding:30px">
                            <h5 class=" fw-normal mt-0 text-truncate text-white text-center" title="Booked Revenue">My Plan</h5>
{{--                            <h3 class="my-2 py-1">ksh {{ $organization_revenue }}</h3>--}}
                            <p class="mb-0 text-muted text-center">
                                <span class=" me-2 text-white text-center"><i class="mdi mdi-arrow-up-bold"></i> Standard</span>
                            </p>
                        </div>
          ...
          <div class="col-lg-6 ">
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-12" style="background: rgb(107, 5, 224);border-radius:15px;padding:30px">
