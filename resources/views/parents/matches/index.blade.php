                                ...
                                @forelse($backMatches as $match)
                                    ...
                                    <tr class="match-row">
                                        ...
                                        <td class="text-center align-middle">
                                            <span class="type-badge type-home">{{ $match->type  }}</span>
                                        </td>
                                        <td class="text-center align-middle">
                                            <div class="odds-display back-odds">
                                                <div class="odds-value">{{ number_format($match->back, 2) }}
                                                </div>
                                        ...
                                        <td class="text-center align-middle d-none d-lg-table-cell bookmaker">
                                            <span class="bookmaker-badge bookmaker-{{ $match->bookmaker }}">
                                                {{ strtoupper(str_replace('_fr', '', $match->bookmaker)) }}
                                            </span>
                                        ...
                                        <td class="text-center align-middle">
                                            <button class="btn btn-sm btn-outline-success calc-btn" data-toggle="modal"
                                                ...
                                                data-back-odds="{{ $match->back }}"
                                                data-lay-odds="{{ $match->lay ?? 0 }}"
                                                data-match="{{ $match->match_details }}"
                                                data-outcome="{{ $match->type }}"
                                                data-bookmaker="{{ $match->bookmaker }}">
